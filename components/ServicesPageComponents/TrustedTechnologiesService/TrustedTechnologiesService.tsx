import scss from './TrustedTechnologiesService.module.scss';
...
const trustedTechnologiesService = [
  {
    items: [
...
export default function TrustedTechnologiesService({ lang }: { lang: string }) {
  const t = getT(lang);

  return (
    <section className={scss.trustedTechnologies}>
      <div className={scss.card}>
        {trustedTechnologiesService.map((block, index) => (
